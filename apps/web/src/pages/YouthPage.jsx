    ...
    <div className="bg-[hsl(var(--background))] min-h-screen">
      ...
      <section className="relative pt-32 pb-24 md:pt-48 md:pb-32 bg-[hsl(var(--black))] overflow-hidden">
        <div className="absolute inset-0 opacity-40">
          <img src="https://images.unsplash.com/photo-1680024439029-d7d4b7f4cba1?auto=format&fit=crop&q=80&w=2000" alt="Youth soccer" className="w-full h-full object-cover" />
          ...
          <motion.div initial="hidden" animate="visible" variants={stagger} className="max-w-3xl">
            ...
            <motion.div variants={fadeUp} className="flex flex-col sm:flex-row gap-4">
              <Button asChild className="bg-[hsl(var(--primary))] hover:bg-[hsl(var(--primary-dark))] text-white nav-text text-lg px-8 py-6 h-auto">
                <a href="https://docs.google.com/forms/d/e/1FAIpQLSeVi7kj8XFcbnbRPP9p9ZXnSFIsc5YgRRSKaFJEmQEw1euwQw/viewform?usp=header" target="_blank" rel="noopener noreferrer">
      ...
      <section className="py-20 md:py-32 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          <div className="relative rounded-2xl overflow-hidden shadow-xl aspect-[4/3]">
            <img src="https://images.unsplash.com/photo-1604651685068-8223d8790770?auto=format&fit=crop&q=80&w=1000" alt="Youth soccer coaching" className="w-full h-full object-cover" />
