    ...
    <div className="bg-[hsl(var(--background))] min-h-screen">
      ...
      <section className="py-24 md:py-32 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="space-y-12 text-[hsl(var(--gray))] text-lg md:text-xl leading-relaxed">
          ...
          <p>
            These founding clubs—Hyde Park Rangers FC, Pilsen FC, Beverly FC, Midway FC, Al Farooq FC, Pico FC, Hunnids Athletic Club, and Bronzeville Athletic Club—are setting the standard. Their success and operational stability will pave the way for future expansions into the North, West, and eventually a unified city championship.
          </p>
        </div>
      </section>
